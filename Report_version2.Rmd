...
summ(newfit2)
```  
\qquad Model2 is built based on the transformed model. Although the residual plot and QQ-plot shows the residuals are normally distributed in this model, the p-value of union density still large and the coefficient of union density is closed to 0.
