...
#data transformation: generate a new variable called Racial_diversity to measure the level of racial diversity
data3 <- data2 %>% 
...
plot(residuals.high,residuals.Union,main = "Partial Correlation for First Model")
...
plot(residuals.high.t,residuals.Union.t,main = "Partial Correlation for Second Model")
...
plot(residuals.high.f,residuals.Union.f,main = "Partial Correlation for Final Model")
