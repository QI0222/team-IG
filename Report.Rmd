...
plot(residuals.high.t,residuals.Union.t,main="Partial Correlation for Transformed Model")
...
plot(residuals.high.f,residuals.Union.f,main = "Partial Correlation for Third Model")
